...
\pretolerance=1000 \tolerance=200 \emergencystretch=10pt
...
$t_2^n(\varphi)$                            & 
$c$-топологически инъективен                &
\ref{PrT2nOfOpIsWellDef}                    \\  % chktex 2
                                            &                              
                                            & 
$\implies$                                  &
${t_2^n(\varphi)}^*$                        & 
строго $c$-топологически сюръективен        &
\ref{PrDualOps}                             \\  % chktex 2
                                            & 
                                            &
$\implies$                                  &
${(\varphi^\triangle)}^{\wideparen{n}}$     & 
строго $c$-топологически сюръективен        &
\ref{PrTwoTypesDualOpEquiv}                 \\  % chktex 2
                                            &
                                            &
$\implies$                                  &
...
Откуда мы получаем $(ii)$ и $(iii)$. Снова для любого $n\in\mathbb{N}$ мы имеем
цепочку ипликаций {\small
\begin{tabular}{llclll}
$\varphi^{\wideparen{n}}$                       &
\begin{tabular}{c} (строго) $c$-топологически   \\
сюръективен\end{tabular}                        & 
$\implies$                                      & 
$t_2^n(\varphi)$                                &
$c$-топологически сюръективен                   &
\ref{PrT2nOfOpIsWellDef}                        \\  % chktex 2
...
Откуда мы получаем $(i)$ и $(iv)$. Пункты $(v)$ и $(vi)$ являются прямым следствием
$(i)$---$(iv)$ при $c=1$ если учесть что $\varphi$ секвенциально сжимающий тогда и
только тогда $\varphi^\triangle$ секвенцильно сжимающий (см. 
предложение~\ref{PrDualSBOp}).
...
{\mathbb{C}^{\Lambda}}\ar[u]_{j}  % chktex 3
\ar[r]_{\varphi}  &{\square_{sqTop}(X)} }  % chktex 3
$$
коммутативна.
...
\ar@{-->}[dr]^{?} & \\  % chktex 3
{\mathbb{C}^\Lambda}\ar[u]_{j'}  % chktex 3
\ar[r]_{ C^{-1}\varphi'}  &{\square_{sqMet}(X)} }  % chktex 3
$$
...
\xymatrix{
SQNor_1^o \ar[d]_{\nabla }  % chktex 3 
\ar[rr]^{(\square_{sqMet}^{d})^o} & & {Set}\ar[d]^{1_{Set}}\\  % chktex 3
SQNor_1
\ar[rr]^{\square_{sqMet}}&  &{Set}}  % chktex 3
$$
...
\xymatrix{
SQNor^o \ar[d]_{\nabla }   % chktex 3
\ar[rr]^{(\square_{sqTop}^d)^o}  % chktex 3
 & & {Nor_0} \ar[d]^{1_{Nor_0}}\\  % chktex 3
...
\bibitem{LamOpFolgen}\textit{Lambert A.} Operatorfolgenr\"{a}ume. Eine Kategorie
