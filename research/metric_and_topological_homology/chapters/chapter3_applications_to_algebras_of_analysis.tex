...
$\bigoplus_\infty \{M_n(\mathbb{C}_s):s\in K \}$ in $\mathbf{mod}-M_n(C(K))$.
...
injective. Since $\mathcal{B}(H)\isom{\mathbf{mod}_1-A}{\mathcal{N}(H)}^*$,
...
of $A_+$ in $A-\mathbf{mod}_1$. From propositions~\ref{UnitalAlgIsMetTopProj}
...
$\mathbb{C}_s\isom{\mathbf{mod}_1-C_0(S)}\mathbb{C}_s^*$. 
\end{proof}
...
$M(S)\isom{\mathbf{mod}_1-C_0(S)}L_1(S,\mu)\bigoplus_1 M_s(S,\mu)$
...
$(ii)$ Since
$L_\infty(S,\mu)\isom{\mathbf{mod}_1-C_0(S)}{L_1(S,\mu)}^*$, the result
...
$(ii)$ Since $M(S)\isom{\mathbf{mod}_1-C_0(S)}{C_0(S)}^*$, the result
immediately follows from proposition~\ref{MetCTopFlatCharac} and paragraph
...
${(L_p(G),\convol_p)}^*\isom{\mathbf{mod}_1-M(G)}(L_{p^*}(G),\cdot_{p^*})$ 
...
Since $L_\infty(G)\isom{\mathbf{mod}_1-L_1(G)}{L_1(G)}^*$, by 
...
an $L_1(G)$-module, $\rho$ is a coretraction in $\mathbf{mod}-L_1(G)$. Denote
...
$M(G)\isom{L_1(G)-\mathbf{mod}_1}L_1(G)\bigoplus_1 M_s(G)$, $M(G)$ is
