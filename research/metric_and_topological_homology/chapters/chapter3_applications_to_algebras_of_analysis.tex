...
is equivalent to measure $\mu$ being purely atomic with finitely many atoms, and
...
$\langle$~projective / injective / flat~$\rangle$. By previous paragraph we get
...
indicate open problems, and ``*'' symbol for partial results. Below is a short 
...
The question of relative projectivity of $C_0(S)$-module $L_\infty(S,\mu)$ is 
...
of $C_0(S)$-module $L_\infty(S,\mu)$ we conjecture that $\mu$ must have a 
compact support. 
