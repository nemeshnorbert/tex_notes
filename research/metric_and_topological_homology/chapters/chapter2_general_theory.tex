...
$\langle$~$\Vert\psi\Vert\leq\Vert\phi\Vert$ / 
$\Vert \psi\Vert\leq c c' C\Vert\phi\Vert$~$\rangle$. Hence, $P$ 
...
\begin{enumerate}[label = (\roman*)]
    ...
    $I=A_\bullet p$ and $\Vert e_{A_\bullet}-p\Vert$ is $\langle$~at most $1$ / at most
    $cC$~$\rangle$;

    \item If there exists an idempotent $p\in I$ such that $I=A_\bullet  p$ and
    $\Vert e_{A_\bullet }-p\Vert$ is $\langle$~at most $1$ / at most
...
$\Vert e_{A_\bullet }-p\Vert
=\Vert(\sigma\pi)(e_{A_\bullet})\Vert
\leq\Vert\sigma\Vert\Vert\pi\Vert\Vert e_{A_\bullet }\Vert
=\Vert\sigma\Vert$.
...
and $\Vert\sigma\Vert\leq\Vert e_{A_\bullet }-p\Vert$. 
...
$\langle$~$\Vert\psi\Vert\leq\Vert\phi\Vert$ / 
$\Vert \psi\Vert\leq c' c C\Vert\phi\Vert$~$\rangle$. Hence, $J$ 
...
by $\Vert \iota_{A_\bullet }(e_{A_\bullet})-p\Vert$. Denote this net by 
...
$$
\sup_{\nu\in N}\Vert e_{A_\bullet }-e_\nu\Vert
\leq\Vert \iota_{A_\bullet }(e_{A_\bullet })-p\Vert
\leq\Vert\tau^*(\pi^{**}(\iota_{A_\bullet }(e_{A_\bullet })))\Vert
\leq\Vert\tau^*\Vert\Vert\pi^{**}\Vert\Vert\iota_{A_\bullet }(e_{A_\bullet })\Vert
=\Vert\tau\Vert
$$
...
\leq\Vert f\Vert\Vert a\Vert\Vert e_{A_\bullet }-e_\nu\Vert
...
\end{proposition}
\begin{proof} Take any $x_0\in X$ with $\Vert x_0\Vert=1$ and using the Hahn-Banach
...
$$
are isomorphisms of right $A$-modules with $\Vert\xi \Vert\leq c_2$ 
...
\leq\Vert\tau^+\Vert$. Consider the maps
