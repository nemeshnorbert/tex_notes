...
In the category $\langle$~$A-\mathbf{mod}_1$ / $A-\mathbf{mod}$~$\rangle$ there
...
In the category $\langle$~$\mathbf{mod}_1-A$ / $\mathbf{mod}-A$~$\rangle$ there
is a special class of $\langle$~metrically / $1$-topologically~$\rangle$
...
a $\langle$~$1$-coretraction / $C$-coretraction~$\rangle$ in $\mathbf{mod}-A$.
\end{proposition}
\begin{proof}
Suppose $J$ is 
...
$\langle$~$-\projmodtens{A}F:\mathbf{mod}_1-A\to\mathbf{Ban}_1$ /
$-\projmodtens{A}F:\mathbf{mod}-A\to\mathbf{Ban}$~$\rangle$ maps
...
a $1$-retract of $X$ in $\langle$~$A-\mathbf{mod}_1$ / $\mathbf{mod}_1-A$~$\rangle$.
\end{proposition}
...
$\langle$~$A-\mathbf{mod}_1$ / $\mathbf{mod}_1-A$~$\rangle$. The argument for
...
So $\tau\pi_F^*=1_{F^*}$. This means that $F^*$ is a $\langle$~$1$-retract /
 ...
 $\langle$~$\mathbf{mod}_1-A$ / $\mathbf{mod}-A$~$\rangle$. Let $i:A\to A_+$ be
