...
$(ii)$ Since $p^2=p$, we have a well-defined closed left ideal $I=A_\times p$ and
...
\begin{enumerate}[label = (\roman*)]
    \item $A_\times /I$ is a $\langle$~metrically / $C$-topologically~$\rangle$
    flat $A$-module;
...
there exists a functional $g\in {(A_\times /I)}^*$ such 
that $f=\pi^*(g)$. Thus,
$$
...
For all $g\in{(A_\times /I)}^*$ and $a+I\in A_\times /I$ we have
$$
\tau(\pi^*(g))(a+I)
