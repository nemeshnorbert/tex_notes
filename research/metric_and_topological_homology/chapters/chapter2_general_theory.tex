...
solved by Helemskii in [\cite{HelHomolBanTopAlg}, theorem VII.1.20].
...
an $L_1$-space is again an $L_1$-space [\cite{LaceyIsomThOfClassicBanSp}, theorem
6.17.3].
...
$(iii)$  By $\langle$~[\cite{GrothMetrProjFlatBanSp}, theorem 1] / the remark after
...
an $\mathscr{L}_1^g$-space [\cite{DefFloTensNorOpId}, corollary 23.2.1(2)].
...
$E^{**}$ has the Dunford-Pettis property, by [\cite{FabHabBanSpTh},
...
$A$, as is any translation invariant subspace of $A$. By [\cite{DefFloTensNorOpId},
...
$\mathbb{T}$ is a compact group, it is amenable [\cite{PierAmenLCA},
