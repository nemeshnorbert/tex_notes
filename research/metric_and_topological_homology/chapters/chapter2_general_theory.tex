...
projective as an $A$-module. Since $A$ is commutative, then for any $A$-morphism
...
$\langle$~isometric / $c$-topologically injective~$\rangle$, then $X_0$ is
...
\end{proposition}
\begin{proof} Since $E$ is an $\mathscr{L}_\infty^g$-space, then $E^*$ is an
...
retract of $E$, then $J$ is also complemented in $K$. Any Banach 
