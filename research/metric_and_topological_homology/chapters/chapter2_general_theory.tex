...
\begin{proposition}[\cite{WhiteInjmoduAlg}, 
    proposition 2.10]\label{MetCTopProjModViaCanonicMorph} An $A$-module $P$ is
...
Clearly, every $C$-topologically projecive module is $C'$-topologically 
...
Clearly, every $C$-topologically injecive module is $C'$-topologically 
