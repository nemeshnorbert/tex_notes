...
Since $P$ is an annihilator module, $P_{ess}= \{0 \}$ and
$P\isom{\mathbf{Ban}_1}P/P_{ess}$. Therefore, by
proposition~\ref{MetTopProjModEssQuotIsProjBanSp} the Banach space $P$ is
$\langle$~metrically / $C$-topologically~$\rangle$ projective and is
...
a right $(C-1)$-bounded approximate identity~$\rangle$. Since $J$ is an
annihilator module, $J_{ann}=J$. Therefore, by
proposition~\ref{MetTopInjModAnnihPartIsInjBanSp} the Banach space $J$ is
...
propositions~\ref{RetrMetCTopInjIsMetCTopInj} and~\ref{MetCTopFlatCharac} the
module $F_{ess}$ is $(1+c)C$-topologically flat. It remains to apply
proposition~\ref{MetTopFlatModEssQuotIsFlatBanSp} to the $C$-topologically flat
$A$-module $F$, which shows that $F/F_{ess}$ is an
$\mathscr{L}_{1,C}^g$-space.
