...
with slight modification of the categories between which these functors act.
...
of measure space is an  arbitrary set $\Lambda$ with the $\sigma$-algebra of all
...
measurable space, with the property that the preimage of every open set is
...
The reason is that any family of Banach spaces admits $\langle$~coproduct /
