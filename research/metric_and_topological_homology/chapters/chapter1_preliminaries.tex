...
More on these matters can be found in [\cite{BourbElemMathGenTopLivIII}, section
7].
...
251N]. By the direct sum of measure spaces $ \{(\Omega_\lambda, \Sigma_\lambda,
...
inside $\ell_\infty(\mathbb{N})$ [\cite{KalAlbTopicsBanSpTh}, theorem 2.5.5].
...
the discussion after [\cite{DalLauSecondDualOfMeasAlg}, proposition 2.14]. 
...
space is weakly compact [\cite{MeggIntroBanSpTh}, theorem 2.8.2], then a reflexive
...
subspace of a space with an unconditional basis [\cite{KalAlbTopicsBanSpTh},
...
called a $W^*$-algebra. By Sakai's well known theorem [\cite{BlackadarOpAlg},
theorem III.2.4.2] each $C^*$-algebra which is dual as a Banach space is a
...
[\cite{HelBanLocConvAlg}, theorem 7.1.60]. As for flatness, such phenomena are
