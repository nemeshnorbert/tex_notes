...
% TODO(norberrt)
% Get rid of rigged categories
%   Check theorem dependencies
%   Delete all mentions of the words admissible, rigged
%       In the abstract
%       In the main text
%   Delete papers that are no longer needed in the text
%   Repeate White's proofs
% Get rid of the incorrect proof of the projectivity of L_p. 
%   Cite my results published at Math Notes.
% Add the following proofs
%   (AX)^\perp= (X^*)^{\perp A}
%   if P is projective, then AP is complemented
%   if J is injective, then J^{\perp A} is complemented
%   change of algebra injectivity, see if we can replace complementability 
%       of the ideal with weak complementability 
%   inductive limit of flat modules is flat
% Fix grammar
