...
Chapter 1 gives the background required for our studies. In paragraph 1.1 we collect
all necessary facts on category theory, topology and measure theory. Paragraph
1.2 contains a brief introduction to Banach structures. Here we discuss Banach
spaces, Banach algebras and Banach modules. In paragraph 1.3 we give a short
introduction to relative Banach homology. 
...
The results of this chapter are extensively used later when dealing with
specific modules of analysis. Let us discuss the contents of this chapter in more
...
examples confirming that a homologically trivial module and its Banach algebra
...
property. Paragraph 2.3 is quite long. Here we list conditions under which
projectivity injectivity and flatness are preserved under transition from
modules over an algebra to modules over an ideal. Finally, we give a necessary and
sufficient condition of topological flatness of a Banach module and a necessary
...
indispensable in the description of homologically trivial modules over algebras of
bounded and compact operators on a Hilbert space. We perform similar research
for the commutative case of algebras of bounded and vanishing functions on discrete
sets and locally compact Hausdorff spaces. In paragraph 3.2 we proceed to study 
standard modules of harmonic analysis. Due to the specific Banach geometric
structure of the convolution algebra and the measure algebra, we easily show that most of
the standard modules of harmonic analysis are homologically non-trivial. The most
intriguing result of the paragraph is a lack of projectivity of the convolution algebra 
